...
script.createEvent("OnStartEvent").bind(function() {
    ...
    script.stateText.text = "Face Left/Right to steer\nUse buttons to Jump/Slide\nPress Start";
...
function setupUiButtons() {
    // NOTE: No UI Button block available; we auto-start on face presence and auto-restart on any head movement.
    script.faceLandmarks.onHeadCenterPosition2DUpdated.add(function(position2d) {
        if (gameState === "IDLE") {
            startGame();
...
function update() {
    ...
    if (gameState === "RUNNING") {
        ...
        // Keep previewing lane aim if face is updating
        // If no face updates for a while, do nothing (pause)
    } else {
