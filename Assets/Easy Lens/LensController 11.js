...
function setupTouchControls() {
    // Ensure double tap is allowed; if block exposes flags, set them here if needed (runtime only)
    if (script.touchEvents && script.touchEvents.allowDoubleTap !== undefined) {
