...
//@input Component.ScriptComponent jumpButton
//@input Component.ScriptComponent slideButton
...
script.createEvent("OnStartEvent").bind(function() {
    ...
    script.jumpButton.enabled = false;
    script.slideButton.enabled = false;
...
// UI Buttons: Start/Restart, Jump, Slide
function setupUiButtons() {
    ...
    // Jump and Slide buttons during gameplay
    script.jumpButton.onPressEnd.add(function() {
        triggerJump();
    });
    script.slideButton.onPressEnd.add(function() {
        triggerSlide();
    });
}
...
function startGame() {
    ...
    script.jumpButton.enabled = true;
    script.slideButton.enabled = true;
